...
#                    print(trace.sampling_rate)
                    plt.plot(t,v,label = 'trace numer = '+str(iteration_number))
                    plt.figtext(1, 0.7, 'membrane voltage before : ' + str(np.around(Vm_i,decimals =1)))
                    plt.figtext(1, 0.65, 'membrane voltage after : ' + str(np.around(Vm_f,decimals = 1)))
                    plt.figtext(1, 0.6, 'membrane voltage variation : ' + str(np.around(del_Vm, decimals = 2)))
